...
document.getElementById('btnGirar180').addEventListener('click', girar180);
document.getElementById('btnGirar270').addEventListener('click', girar270);
document.getElementById('btnRedimensionar4X').addEventListener('click', redimensionar4X);
document.getElementById('btnRedimensionar2X').addEventListener('click', redimensionar2X);
document.getElementById('btnRedimensionar12').addEventListener('click', redimensionar12X);
document.getElementById('btnRedimensionar14').addEventListener('click', redimensionar14);